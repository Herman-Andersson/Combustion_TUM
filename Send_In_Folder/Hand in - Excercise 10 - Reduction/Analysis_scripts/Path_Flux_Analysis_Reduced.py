...
### gas= ct.Solution("/home/brukare/Combustion/RMG_Reduced/reduced_17.yaml")
### gas.set_equivalence_ratio(1.1, 'CH4', 'O2:2.0, N2:7.52')

gas = ct.Solution("/home/brukare/Combustion/RMG_Reduced/reduced_24.yaml")
gas.set_equivalence_ratio(1.1, 'CH4', 'O2:2.0, N2:7.52')
...
output_dir = '/home/brukare/Combustion/RMG_Reduced/Analysis_scripts/' 
